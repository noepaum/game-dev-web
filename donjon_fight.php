<?php
    ...
    if ($_SESSION['fight']['ennemi']->speed > $_SESSION['perso']['vit']) {
        ...
        if ($_SESSION['perso']['pdv'] <= 0) {
            ...
            if ($touche >= 10) {
                ...
                if ($_SESSION['fight']['ennemi']->pol <= 0) {
                    if($nb <= 8 && runaway() == 1){
                        $_SESSION['fight']['html'][] = "Votre ennemi a fui.";
                    }
                    else{
        ...
        if ($touche >= 10) {
            ...
            if ($_SESSION['fight']['ennemi']->pol <= 0) {
                if($_SESSION['fight']['ennemi']->name == 'Gobelin' && $_SESSION['fight']['ennemi']->runaway() == 1){
                    $_SESSION['fight']['html'][] = "Votre ennemi a fui.";
                }
                else{
                    $_SESSION['perso']['gold'] += $_SESSION['fight']['ennemi']->gold;
...
?>
    <style>
    body {
        background-image: url(img/salle-de-gardes.jpg);
